...
class  ContenedorMongoDB {
    ...
    deleteByName= async(nombre)=>{//    deleteByName(nombre): void - Elimina del archivo el objeto con el nombre buscado
        try{
            await this.datos.db(this.nombreDb).collection(this.nombreColeccion).findOneAndDelete({"nombre": nombre})
        }catch{
            logger.error('Error al obtener al borrar el nombre');
            throw new Error('Error al obtener al borrar el nombre');
        }
    }
